					...
					<view>
						<view v-if="hasLogin" class="text-white flex">
							<navigator url="/member/member/message" style="margin-left: 20rpx;position: relative;">
								<uni-badge :text="newMsgNum" type="red" class="badge"  style="position: absolute;right: -20rpx;top: -20rpx;"></uni-badge>
		...
		<view class="item-box-container">
			<view class="item-box">
				...
				<view class="m-ber">
					<view class="m-cell m-cell-access m-info-sp">
						<view class="m-cell-bd">
							<navigator url="/edu/order/list?type=0&sl=1&kind_id=1205" class="m-order-title" hover-class="none">
								<label class="m-ber-n m-ber-title">{{__('课程订单')}}</label>
								<label>
									<image  class="nav-image" lazy-load src="/static/images/nav.png" mode="scaleToFill" />
									<label class="m-ber-n" style="float:right;margin-right:20upx;color:#999">{{__('查看全部')}}</label>
								</label>
				...
				<view class="m-panel-bd" style="margin-top: 0;">
					<view class="m-media-box m-media-box-small-appmsg">
						<view :class="{'m-cells':1, iconBoxLattice:PersonalCenterList.type==2}">
							<navigator url="/edu/order/list?type=2010&sl=2&kind_id=1205" class="m-cell m-cell-access">
								<uni-badge v-if="(orders.edu_wait_num >0)" :text="orders.edu_wait_num" type="purple" class="badge"></uni-badge>
								<view class="m-cell-hd " style="color:#ff6700">
									<label class="iconfont zc zc-daizhifu"></label>
								</view>
								<view class="m-cell-bd m-cell-primary">
							...
							<navigator url="/edu/order/list?type=2070&sl=3&kind_id=1205" class="m-cell m-cell-access">
								<uni-badge v-if="(orders.edu_cancel_num >0)" :text="orders.edu_cancel_num" type="purple" class="badge"></uni-badge>
								<view class="m-cell-hd " style="color:#ff6700">
									<label class="iconfont zc zc-daifahuo2"></label>
								</view>
								<view class="m-cell-bd m-cell-primary">
							...
							<navigator url="/edu/order/list?type=2060&sl=4&kind_id=1205" class="m-cell m-cell-access">
								<uni-badge v-if="(orders.edu_fin_num >0)" :text="orders.edu_fin_num" type="purple" class="badge"></uni-badge>
								<view class="m-cell-hd " style="color:#ff6700">
									<label class="iconfont zc zc-yiwancheng"></label>
								</view>
								<view class="m-cell-bd m-cell-primary">
				...
				<view class="m-panel-bd" style="margin-top: 0;">
					<view class="m-media-box m-media-box-small-appmsg">
						<view :class="{'m-cells':1, iconBoxLattice:PersonalCenterList.type==2}">
							...
							<navigator url="/edu/lecturer/subscribe" class="m-cell m-cell-access" v-if="true">
								<view class="m-cell-hd " style="color:#db384c">
									<label class="iconfont zc zc-xiangqing"></label>
								</view>
								<view class="m-cell-bd m-cell-primary">
							...
							<navigator url="/edu/cert/user-cert" class="m-cell m-cell-access" v-if="true">
								<view class="m-cell-hd " style="color:#db384c">
									<label class="iconfont zc zc-xiangqing"></label>
								</view>
								<view class="m-cell-bd m-cell-primary">
