	...
	<view class="video-item-content" @click="onTap">
		<view class="item-top-view">
			<view class="item-image-content" >
				<image class="curriculum-image" :src="itemmodel.portraitUrl" mode="aspectFill"></image>
			</view>
		</view>
		<view class="item-bottom-view">
			<view class="item-bottom-des">{{ itemmodel.media_name }}</view>
			<view class="item-bottom-con">
				<!-- <view class="bottom-image-content"> -->
					<image class="bottom-image-content" :src="itemmodel.portraitUrl" mode=""></image>
				<!-- </view> -->
