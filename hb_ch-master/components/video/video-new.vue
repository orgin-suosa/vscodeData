<template>
	<view style="position: relative;"
		...
		<cover-view class="cover-view-right">
			...
			<cover-image src="https://static.shopsuite.cn/xcxfile/appicon/video/img/ay2.png" style="height: 80upx;" class="img-left" @click.stop="tapMsg"></cover-image>
			<text class="right-text">{{ pinglun }}</text>
			<cover-image src="https://static.shopsuite.cn/xcxfile/appicon/video/img/b6p.png" style="height: 76upx;" class="img-left" @click.stop="tapShare"></cover-image>
