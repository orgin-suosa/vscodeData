<template>
	<view>
		...
		<view class="lecturer_info" :style="{'height':userInfoHeight+'px'}">
			...
			<u-button class="sub_btn" type="primary" shape="circle" @click="subLecturer(lecturerDetail.user_id)">{{subText}}</u-button>
		...
		<view class="context_box">
			<view class="course-tabs" style="margin: 0 30rpx;">
				<u-tabs ref="uTabs" itemStyle="font-size:35rpx;width:50%;padding:0px;height:100rpx;line-height:100rpx;background:#ffffff;margin-top:20upx;border-bottom:0.1rpx solid #EBEBEB;"  
				lineColor="#F43D3E" lineHeight="5" :list="list" :current="current" @change="tabsChange" :activeStyle="{ color: '#000000', fontWeight: 'bold' }" :inactiveStyle="{ color: '#666666' }"></u-tabs>
			</view>
			<view>
						...
						<view class="flex-col-content" @click="jumpDetail(item)">
							...
							<u-button class="col_text5" type="default" shape="circle" size="small">
								...
								<view v-if="item.chapter">
									<text style="margin-left: 10rpx;font-size: 16rpx">{{item.chapter.chapterNum}}节课时</text>
								</view>
							</u-button>
