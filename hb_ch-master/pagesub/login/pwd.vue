<template>
    <view class="content">
            ...
            <view class="m-cells m-cells-form">
                <view class="m-cell">
                    ...
                    <view class="m-cell-bd">
                        <input class="u-input" type="number" v-model="user_mobile" name="user_mobile"  :placeholder="__('请输入手机号码')" maxlength="11" @input="onInputMobile"/>
                    </view>
                ...
                <view class="m-cell">
                    ...
                    <view class="m-cell-bd">
                        <input class="u-input" type="number" name="channel_verify_code" v-model="channel_verify_code"  :placeholder="__('请输入手机验证码')"/>
                    </view>
                </view>
                <view class="m-cell">
                    <view class="m-cell-hd"><label class="u-label">{{__('新 密 码')}}</label></view>
                    <view class="m-cell-bd">
                        <input class="u-input" type="text" name="user_password" :placeholder="__('新密码')"  :value="user_password" @input="onInputNewPassword"/>
                    </view>
        ...
        <verifycode-dialog :show="showCodeDialog" :len="4" :autoCountdown="true" :phone="user_mobile" v-on:change="change"></verifycode-dialog>
    </view>
</template>
<script>
