    ...
    <view class="body">
        <view class="header member-top">
            <view class="header-top hide">
                <image :src="plantformInfo.bg || 'https://www.suteshop.com/site/static/src/default/images/landing/bbc.jpg'"></image>
            </view>
        ...
        <view class="message">
            ...
            <view class="tel aboutUs" bindtap="call">
                <view>{{__('联系方式：')}}</view>
                <image src="https://static.shopsuite.cn/xcxfile/appicon/img/call.png" style="width:30upx;height:30upx;margin-right:10upx"></image><label
