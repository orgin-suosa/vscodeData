...
<template>
	...
	<view class="gift-menu"><text class="gm-item gm-item-on">礼物</text><text class="gm-item" v-if="false">背包</text></view>
		<view class="gift-coins"><text class="iconfont zc gc-coin">&#xe889;</text><text class="gc-num">1280</text><text class="gc-recharge">充值</text></view></view>
