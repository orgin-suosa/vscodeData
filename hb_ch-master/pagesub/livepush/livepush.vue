	...
	export default {
		data() {
			return {
				...
				currentWebview:null,
				pusher:null,
				livepushurl:'rtmp://push.shopsuite.cn/shopsuite/10002?auth_key=1581573300-0-0-7b84182ecdc2728a1f8c366b12644c49',
		...
		methods: {
			...
			plusReady(){
				...
				this.pusher =new plus.video.LivePusher('pusher',{
					url:'rtmp://push.shopsuite.cn/shopsuite/10002?auth_key=1581573300-0-0-7b84182ecdc2728a1f8c366b12644c49',
					top:'0',
					left:'0px',
					width: '100%',
