    ...
    <view class="page">
        <scroll-view scroll-y="true" class="m-orderlist" @scrolltolower="scrollbottom" @scrolltoupper="scrollView" @scroll="bindscroll">
            <view class='banner-nav'>
                ...
                <view class='input_box2' style='background: #f1f1f1;' v-if="NIndex">
                    ...
                    <input :value="story_index" class="input_box2_input" :placeholder="__('搜索您想看的内容')"
                           placeholder-style="font-size:30upx;color:#959593;line-height:54upx"
                           confirm-type="done"  @confirm="searchinput"/></view>
                <view class='sq_0-box'>
                    <navigator hover-class="none" :url="'/communityCopy/community/userspace?uid=' + userInfo.user_id"
            ...
            <view class='box_title_box' v-for="(item, i) in MemberPostsList" :key="i">
                <view class='box_title'>
                    <navigator hover-class="none" :url='"/communityCopy/community/userspace?uid=" + item.user_id'
                ...
                <navigator @tap="moNitor" hover-class="none" :url='"/communityCopy/community/detail?id="+item.story_id'
        ...
        <view class="u-top-default">
                <image  @click="onPostStory" src='https://static.shopsuite.cn/xcxfile/appicon/nav/black/nav_post.png' class='quicknav'
                       style='position: fixed;right: 20rpx;bottom:120rpx'></image>
    ...
    export default {
        ...
        methods: {
            ...
            onPostStory: function (a) {
                let that = this;
                that.forceUserInfo(function(user) {
                    that.$.navigateTo({url: "/communityCopy/community/post"})
                })
            },
            ...
            searchinput: function (a) {
                wx.navigateTo({
                    url: "/communityCopy/community/lists?story_index=" + a.detail.value,
                    success: function (a) {
                    },
                    fail: function (a) {
                    },
...
<style lang="scss">
    ...
    .box_title_conton {
        padding: 0upx 30upx 25upx 30upx;
        font-size: 30upx;
        /*line-height: 53upx;*/
        width: 690upx;
        /*height: 40upx*/;
