    ...
    <view>
                    ...
                    <block v-for="(item, index) in ImgList" :key="index">
                        <view style='display: inline-block;position: relative'>
                            ...
                            <view class='shanchu' style=''>
								<label @tap='delImg' class="iconfont icon-delete"
                                                                  :data-id="item.SkuId" :data-index="index"
                                                                  style='color:#fff'></label>
                            </view>
                        </view>
                    </block>
                    <view @click='chooseVideoImage' style='display: inline-block;position: relative'>
                ...
                <view class='bk_box'>
                    ...
                    <view class='pic_box_pic'>
                        <view style='display: inline-block;'>
                            <view style='display: inline-block;'>
                                <view class='pic_box_image' :style='"background: url(" + item.product_image + ") center no-repeat ;background-size:cover;"' v-for="(item, index) in shopback" :key="index">
                                ...
                                <image @tap='shopsearch' class='pic_box_image' src='https://static.shopsuite.cn/xcxfile/appicon/img/pic_11.png' v-if="shopback.length < 4"></image>
                            </view>
                        </view>
                    </view>
                </view>
        ...
        <view class='fabu_box'>
            <view @tap="AddMemberPosts">
                <view class='fabu_box_fb'>{{__('发布')}}</view>
            </view>
