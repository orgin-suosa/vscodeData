    ...
    <view class="page">
        <view class="topbg">
            <view class="topinfo">
                ...
                <view class="portionMoney"><label>{{sprintf(__('余额 ￥%s'), CashData.user_money)}}</label><label>{{sprintf(__('佣金 ￥%s'), CashData.user_commission_buy)}}</label></view>
        ...
        <view class="m-cells">
            ...
            <navigator url="/member/fans/profitlist" class="m-cell m-cell-access" v-if="(isMemDist)">
                ...
                <view class="m-cell-ft">{{CashData.commission_buy_amount}}</view>
            </navigator>
