<template>
	<view class="page">
		<view class="feedback-box">
			<view class="m-cells m-cells-form">
				<view class="m-cell">
					<view class="m-cell-bd">
						<textarea class="u-textarea" maxlength="500" :placeholder="__('感谢提出建议')" @input="inputRemark" style="height:300upx;"></textarea>
			...
			<view hidden="true" class="m-cells m-cells-form" style="margin-top:80upx;">
				<view class="m-cell">
