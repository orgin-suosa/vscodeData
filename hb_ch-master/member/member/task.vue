			...
			<view style="background:#f7f7f7;position:relative">
				<view class="header">
					<view :class="member.IsEnabled?'header-top':'if_carh1'">
						...
						<view v-if="member.IsEnabled && member.IsReceive && member.ReciveStatus == 1 && member.IsToWeixin "
							...
							<image style="width: 106px;height: 29px;border-radius: 0;" src='https://static.shopsuite.cn/xcxfile/appicon/img/cardp-bg.png'></image>
						</view>
					</view>
				</view>
				...
				<view style='background:#fff'>
					...
					<view class="mission" style='padding:26rpx 0rpx' v-if="false">
						<view class="draw">
							<image style='width:12px;height:12px' src="https://static.shopsuite.cn/xcxfile/appicon/img/qiandao.png"></image>
							<text>{{__('签到领积分')}}</text>
						</view>
					...
					<view class="mission" style='padding:26rpx 0rpx'>
						<view class="draw">
							<image style='width:12px;height:10px' src="https://static.shopsuite.cn/xcxfile/appicon/img/gouwu.png"></image>
							<text>{{__('购物领积分')}}</text>
						</view>
					...
					<view class="mission" style='padding:26rpx 0rpx'>
						<view class="draw">
							<image style='width:12px;height:12px' src="https://static.shopsuite.cn/xcxfile/appicon/img/pinglun.png"></image>
							<text>{{__('评价领积分')}}</text>
						</view>
