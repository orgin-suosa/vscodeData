<template>
    <view class="page">
        <view class="topbg">
            <view class="topinfo">
                <navigator  :url="'../cash/balance?user_total_weath=' + (CashData.user_total_weath) + '&user_money=' + (CashData.user_money) + '&commission_amount=' + (CashData.commission_amount) + '&user_commission_now=' + (CashData.user_commission_now) + '&user_commission_buy=' + (CashData.user_commission_buy)">
                    <label>{{__('￥')}}</label><label style="font-size:56px">{{CashData.user_total_weath}}</label>
                </navigator>
				<block v-if="(isMemDist)">
                <view class="portionMoney"><label>{{__('余额')}} {{__('￥')}}{{CashData.user_money}}</label><label>{{__('佣金')}} {{__('￥')}}{{CashData.user_commission_now}}</label></view>
