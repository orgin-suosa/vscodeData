<template>
  <view class="banner-wrap">
    ...
    >
      <swiper-item :style="'width:' + imgWidth  + 'height:' + imgHeight" v-for="(item,index) in imageList" :key="index">
        <view :style="'width:' + imgWidth  + 'height:' + imgHeight " class="banner-swiper-item" >
          <image
