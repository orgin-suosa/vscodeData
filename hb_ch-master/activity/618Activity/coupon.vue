...
export default {
  ...
  data() {
    return {
      ...
      activityButton: `${getApp().globalData.qnUrl}/zc_images/activity/618Activity01.png`,
      activityTitle: `${getApp().globalData.qnUrl}/zc_images/activity/618Activity02.png`,
      modalSure: `${getApp().globalData.qnUrl}/zc_images/activity/modalSure.png`,
      modalClose: `${getApp().globalData.qnUrl}/zc_images/activity/modalClose.png`,
      addAdviser: `${getApp().globalData.qnUrl}/zc_images/activity/addAdviser.png`,
      receivedTitle: `${getApp().globalData.qnUrl}/zc_images/activity/received-title.png`,
      //   couponBg: `${getApp().globalData.qnUrl}/zc_images/activity/coupon-bg.png`,
      buttonUse: `${getApp().globalData.qnUrl}/zc_images/activity/buttonUse.png`,
      PageNav: {
        window: {
      ...
      activityShare: `${getApp().globalData.qnUrl}/zc_images/activity/activityShare.png`,
      isWXconfig: true,
      isWX: null,
      htmTitle: '',
