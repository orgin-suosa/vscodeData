...
<!-- 	<image class="buyButton" :src="buy" mode="widthFix" @click="goTop()"></image> -->
	<view class="verifyLoginContent" ref="verifyLogin">
		<verifyLogin  class="verifyLogin" :buy="buy" signInButtonText="¥0.99元立即抢购" @goTop="goTop" @loginJump="loginJump">
		</verifyLogin>
...
export default {
  ...
  data() {
    return {
	  ...
	  showPay:false,
      stockPicking: `${getApp().globalData.qnUrl}/zc_images/activity/stockPicking.png`,
	  buy: `${getApp().globalData.qnUrl}/zc_images/activity/buy.png`,
      PageNav: {
        window: {
