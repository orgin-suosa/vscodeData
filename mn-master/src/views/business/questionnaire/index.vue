<template>
  <page-model :has-back="true" :title="pageModelTitle" :custom-back="true" page-bg-color="#fff" :header-style="{ fontSize: '14px' }" @back="back">
    ...
    /> -->
      ...
      <!-- <div class="answer" v-for="(currentItem, i) in questionArr" :key="i">
  ...
  data() {
    return {
      ...
      questionList: [
        {
          answer: '',
          id: '833722512419323904',
          type: '1', // 单选
          options: [
            { content: 'A:人生的体验越多越好，所以想法很多，有可能就应该多尝试。 ', id: '833722512478044160', num: '1', questionId: '833722512419323904' },
            { content: 'B:深度比宽度更重要，目标要谨慎，一旦确定就坚持到底。 ', id: '833722512499015680', num: '2', questionId: '833722512419323904' },
            { content: 'C:人生必须有所成。 ', id: '833722512515792896', num: '3', questionId: '833722512419323904' },
            { content: 'D: 没必要太辛苦，好好活着就行。', id: '833722512536764416', num: '4', questionId: '833722512419323904' },
          ],
          title: '我的人生观是',
          erroreMssage: ' ',
        },
        {
          ...
          type: '2', // 多选
          options: [
            { content: 'A:问卷调查。 ', id: '833722512478044160', num: '1', questionId: '833722512419323904' },
            { content: 'B:满意度调查 ', id: '833722512499015680', num: '2', questionId: '833722512419323904' },
            { content: 'C:投票评选 ', id: '833722512515792896', num: '3', questionId: '833722512419323904' },
          ],
          list: ['1', '2', '3'],
          listTitle: ['A:问卷调查', 'B:满意度调查', 'C:投票评选'],
          result: [],
          title: '您经常创建什么类型的项目？',
          erroreMssage: '',
        },
        ...
        },
        {
          ...
          options: [
            {
              content: 'A:问卷调查。 ',
              listImg: 'https://maniu-app-test.oss-cn-shanghai.aliyuncs.com/acquisiton-tool/character.png',
              id: '833722512478044160',
              num: '1',
              questionId: '833722512419323904',
            },
            {
              content: 'B:满意度调查 ',
              listImg: 'https://maniu-app-test.oss-cn-shanghai.aliyuncs.com/acquisiton-tool/aptitude.png',
              id: '833722512499015680',
              num: '2',
              questionId: '833722512419323904',
            },
            {
              content: 'C:投票评选 ',
              id: '833722512515792896',
              listImg: 'https://maniu-app-test.oss-cn-shanghai.aliyuncs.com/acquisiton-tool/character.png',
              num: '3',
              questionId: '833722512419323904',
            },
            {
              content: 'D:投票评选 ',
              id: '833722512515792897',
              listImg: 'https://maniu-app-test.oss-cn-shanghai.aliyuncs.com/acquisiton-tool/character.png',
              num: '4',
              questionId: '833722512419323905',
            },
          ],
          list: ['a', 'b', 'c', 'd'],
          listTitle: ['A:问卷调查', 'B:满意度调查', 'C:投票评选', 'D:多数投票评选'],
          listImg: [
            'https://maniu-app-test.oss-cn-shanghai.aliyuncs.com/acquisiton-tool/character.png',
            'https://maniu-app-test.oss-cn-shanghai.aliyuncs.com/acquisiton-tool/aptitude.png',
            'https://maniu-app-test.oss-cn-shanghai.aliyuncs.com/acquisiton-tool/character.png',
            'https://maniu-app-test.oss-cn-shanghai.aliyuncs.com/acquisiton-tool/aptitude.png',
          ],
          result: [],
        ...
        {
          answer: '',
          id: '833722512419323956',
          type: '4', // 填空
          options: [{ content: '', id: '833722512474544160', num: '1', questionId: '833776512419323904' }],
          title: '对我们的服务有什么建议吗',
          erroreMssage: '',
        },
      ],
    ...
    getQuestionList(getParams, from) {
      ...
      this.$store.dispatch('challenge/selectQuestionList', { baseInfoId: this.id }).then((res) => {
        ...
        if (res.code === 200) {
          ...
          console.log('展业工具题目列表数据-questionArr', this.questionArr);
