<template>
  <div>
    <van-popup class="van-popup-results" v-model="showPopup">
      <ResultText ref="resultText" :result="getResult" :type="type" :isPopup="true" :isParticipate="isParticipate" />
    </van-popup>
    <div class="closeBox" v-if="showPopup" @click="closeClick">
...
<script>
import ResultText from '../annuity/components/resultText.vue';
export default {
  name: 'PopupAnnuity',
  components: {
    ResultText,
